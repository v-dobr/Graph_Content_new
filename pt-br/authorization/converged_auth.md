# <a name="authenticate-microsoft-graph-apps-with-the-azure-ad-v2.0-endpoint"></a>Autenticar aplicativos do Microsoft Graph com o ponto de extremidade do Azure AD v2.0
