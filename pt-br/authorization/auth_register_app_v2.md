## <a name="register-your-microsoft-graph-application-with-the-azure-ad-v2.0-endpoint"></a>Registrar seu aplicativo Microsoft Graph com o ponto de extremidade do Azure AD v2.0
