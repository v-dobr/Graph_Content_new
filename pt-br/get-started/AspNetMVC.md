# <a name="get-started-with-microsoft-graph-in-an-asp.net-4.6-mvc-app"></a>Introdução ao Microsoft Graph em um aplicativo do ASP.NET 4.6 MVC
...
Para baixar uma versão da exemplo de Connect que usa o ponto de extremidade do Azure AD e acessa o Microsoft Graph usando chamadas REST, confira [Exemplo do Office 365 Connect ASP.NET MVC](https://github.com/microsoftgraph/aspnet-connect-rest-sample).
...
O URI de redirecionamento é a URL do projeto que você registrou. Os [escopos de permissão](https://graph.microsoft.io/en-us/docs/authorization/permission_scopes) solicitados permitem que o aplicativo obtenha informações de perfil de usuário e envie um email.
