# <a name="authenticate-microsoft-graph-apps-with-the-azure-ad-v2.0-endpoint"></a>Проверка подлинности в приложениях Microsoft Graph с использованием конечной точки Azure AD версии 2.0
